---
name: "OPSX: Beads"
description: Port an OpenSpec change into beads epics and features for work tracking
category: Workflow
tags: [workflow, beads, tracking]
---

Port an OpenSpec change into beads for pre-implementation work tracking.

**Input**: Change name is required (e.g., `/opsx:beads persist-risk-analysis`). If omitted, prompt the user to provide it.
...
2. **Validate the change exists and has tasks**
   ...
   If missing tasks.md: "This change has no tasks.md file. Use /opsx:continue to create one first."
